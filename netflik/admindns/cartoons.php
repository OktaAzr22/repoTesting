...
<head>
    ...
    <title>Daftar Cartoons</title>
    <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css">
</head>
<body>
    <div class="container">
        <h2 class="mt-4">Daftar Cartoons</h2>
        <a href="tambahcartoons.php" class="btn btn-primary mb-3">Tambah Cartoons</a>
            ...
            <tbody>
                <?php while ($data = mysqli_fetch_array($result)) { ?>
                    <tr>
                        ...
                        <td>
                            <a href="editcartoons.php?id=<?php echo $data['id_cartoons']; ?>" class="btn btn-warning btn-sm">Edit</a> 
                            
                            <a href="hapuscartoons.php?id=<?php echo $data['id_cartoons']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Apakah Anda yakin ingin menghapus cartoons ini?');">Hapus</a>
                        </td>
                    </tr>
                <?php } ?>
            </tbody>
