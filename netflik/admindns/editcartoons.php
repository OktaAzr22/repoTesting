...
$query = "SELECT * FROM cartoons WHERE id_cartoons = '$id'";
    ...
    if (!empty($_FILES["foto"]["tmp_name"])) {
        ...
        if ($uploadOk == 0) {
            ...
            if (move_uploaded_file($_FILES["foto"]["tmp_name"], $target_file)) {
                ...
                $update_query = "UPDATE cartoons SET 
                                    judul = '$judul',
                                    durasi = '$durasi',
                                    sutradara = '$sutradara',
                                    ...
                                    url_video = '$url',
                                    foto = '$target_file'
                                WHERE id_cartoons = '$id'";

                if (mysqli_query($dbb, $update_query)) {
                    echo "<script>alert('Data berhasil diperbarui'); window.location='cartoons.php';</script>";
                } else {
