...
$query = "SELECT * FROM seriess WHERE id_seriess = '$id'";
    ...
    if (!empty($_FILES["foto"]["tmp_name"])) {
        ...
        if ($uploadOk == 0) {
            ...
            if (move_uploaded_file($_FILES["foto"]["tmp_name"], $target_file)) {
                ...
                $update_query = "UPDATE seriess SET 
                                    judul = '$judul',
                                    durasi = '$durasi',
                                    sutradara = '$sutradara',
                ...
                if (mysqli_query($dbb, $update_query)) {
                    echo "<script>alert('Data berhasil diperbarui'); window.location='seriess.php';</script>";
                } else {
...
<body>
    ...
    <form method="POST" action="" enctype="multipart/form-data">
        ...
        <input type="duration" name="durasi" value="<?php echo $data['durasi']; ?>" required><br>
