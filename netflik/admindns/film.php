...
<body>
    <div class="container mt-4">
        ...
        <a href="tambah_film.php" class="btn btn-primary mb-3">Tambah Film</a>
                    ...
                    <tr class="text-center">
                        <td>
                            <?php if (!empty($data['foto'])) { ?>
                                <img src="<?php echo htmlspecialchars($data['foto']); ?>" alt="Foto" style="width: 100px; height: auto;">
                            <?php } else { ?>
                                <img src="uploads/default.png" alt="Foto Tidak Ada" style="width: 100px; height: auto;">
                            <?php } ?>
                        </td>
                        ...
                        <td>
                            <a href="editfilm.php?id=<?php echo htmlspecialchars($data['id_film']); ?>" class="btn btn-warning btn-sm">Edit</a> 
                            <a href="hapusfilm.php?id=<?php echo htmlspecialchars($data['id_film']); ?>" 
