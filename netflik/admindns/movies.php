...
<body>
    <div class="container">
        <h2 class="mt-4">Daftar Movie</h2>
        <a href="tambah_movie.php" class="btn btn-primary mb-3">Tambah Movie</a>
            ...
            <tbody>
                <?php while ($data = mysqli_fetch_array($result)) { ?>
                    <tr>
                        ...
                        <td>
                            <a href="editmovie.php?id=<?php echo $data['id_movie']; ?>" class="btn btn-warning btn-sm">Edit</a> 
                            
                            <a href="hapusmovie.php?id=<?php echo $data['id_movie']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Apakah Anda yakin ingin menghapus film ini?');">Hapus</a>
                        </td>
                    </tr>
                <?php } ?>
            </tbody>
