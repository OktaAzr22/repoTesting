...
<body>
    <div class="container">
        ...
        <a href="tambah_series.php" class="btn btn-primary mb-3">Tambah Series</a>
            ...
            <tbody>
                <?php while ($data = mysqli_fetch_array($result)) { ?>
                    <tr>
                        ...
                        <td>
                            <a href="editseries.php?id=<?php echo $data['id_seriess']; ?>" class="btn btn-warning btn-sm">Edit</a> 
                            
                            <a href="hapusseries.php?id=<?php echo $data['id_seriess']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Apakah Anda yakin ingin menghapus film ini?');">Hapus</a>
                        </td>
                    </tr>
                <?php } ?>
            </tbody>
