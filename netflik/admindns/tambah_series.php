...
<body>
    <h1>Tambah Series</h1>
    <form action="simpanseries.php" method="POST" enctype="multipart/form-data">
        ...
        <input type="decimal" id="rating" name="rating" min="1" max="10" required><br><br>

        <label for="deskripsi">Deskripsi:</label>
        <input type="text" id="deskripsi" name="deskripsi" required><br><br>

        <label for="url">URL Series:</label>
        <input type="url" id="url_video" name="url_video" required><br><br>

        <label for="foto">Foto:</label>
        <input type="file" id="foto" name="foto" accept="image/*" required><br><br>

        <button type="submit" name="simpan">Simpan Series</button>
    </form>
</body>
</html>