...
<head>
    ...
    <title>Tambah Cartoons</title>
</head>
<body>
    <h1>Tambah Cartoon</h1>
    <form action="simpancartoons.php" method="POST" enctype="multipart/form-data">
        ...
        <button type="submit" name="simpan">Simpan Cartoons</button>
    </form>
</body>
</html>