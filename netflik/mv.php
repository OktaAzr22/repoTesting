...
$id_movie = isset($_GET['id_movie']) ? $_GET['id_movie'] : null;
    ...
    if ($result->num_rows > 0) {
        ...
        <div class="container">
            ...
            <iframe 
                width="560" 
                height="315" 
                src="<?php echo convertToEmbedUrl($movie['url_video']); ?>" 
                frameborder="0" 
                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" 
                allowfullscreen>
            </iframe>
            <div class="movie-info">
                <img src="<?php echo htmlspecialchars($movie['foto']); ?>" alt="Poster" class="poster" onerror="this.src='default-image.jpg';">
                <div class="details">
                    <div class="title"><?php echo htmlspecialchars($movie['judul']); ?></div>
                    <div class="rating">Rating: <?php echo $movie['rating']; ?> 
                        <span class="stars">★★★★★</span>
                    </div>
                    <div class="description"><?php echo htmlspecialchars($movie['deskripsi']); ?></div>
                    <div class="additional-info">
                        Sutradara: <?php echo htmlspecialchars($movie['sutradara']); ?><br>
                        Durasi: <?php echo $movie['durasi']; ?><br>
                        Tahun Rilis: <?php echo $movie['tahun_rilis']; ?>
                    </div>
                </div>
            </div>
        </div>
        ...
        echo "<p>Movie tidak ditemukan.</p>";
    }

    $stmt->close();
} else {
    echo "<p>Movie tidak dipilih.</p>";
}
