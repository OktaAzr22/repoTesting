    ...
    if ($result->num_rows > 0) {
        ...
        <div class="container">
            ...
            <iframe 
                width="560" 
                height="315" 
                src="<?php echo convertToEmbedUrl($film['url_video']); ?>" 
                frameborder="0" 
                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" 
                allowfullscreen>
            </iframe>
            <div class="movie-info">
                <img src="<?php echo htmlspecialchars($film['foto']); ?>" alt="Poster" class="poster" onerror="this.src='default-image.jpg';">
                <div class="details">
                    <div class="title"><?php echo htmlspecialchars($film['judul']); ?></div>
                    <div class="rating">Rating: <?php echo $film['rating']; ?> 
                        <span class="stars">★★★★★</span>
                    </div>
                    <div class="description"><?php echo htmlspecialchars($film['deskripsi']); ?></div>
                    <div class="additional-info">
                        Sutradara: <?php echo htmlspecialchars($film['sutradara']); ?><br>
                        Durasi: <?php echo $film['durasi']; ?><br>
                        Tahun Rilis: <?php echo $film['tahun_rilis']; ?>
                    </div>
                </div>
            </div>
        </div>
